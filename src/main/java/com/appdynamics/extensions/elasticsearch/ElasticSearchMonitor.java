...
public class ElasticSearchMonitor extends AManagedMonitor {
	...
	private String indexStatsJsonStr;
	private String nodesStatsJsonStr;
	private String clusterStatsJsonStr;
	...
	private String getJsonResponseString(String resource) {
		...
		if (response.isExceptionHappened()) {
			logger.error("Elastic search instance down OR Stats URL incorrect.");
			throw new RuntimeException("Elastic search instance down OR Stats URL incorrect.");
		}
